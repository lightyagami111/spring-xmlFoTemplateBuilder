...
<fo:block>
	...
	<fo:table table-layout="fixed" width="100%" border-collapse="separate" font-size="10pt" space-before="15mm">
...
<fo:block>
 ...
 <xsl:value-of select="//request/customerInformation/addr1"/> &#160;  <xsl:value-of select="//request/customerInformation/houseNumber"/> &#160; 
 ...
 <xsl:value-of select="//request/customerInformation/postcode"/> &#160;  <xsl:value-of select="//request/customerInformation/city"/> &#160; 
...
<fo:table-cell>
    ...
    <xsl:call-template name="intersperse-with-zero-spaces">
        <xsl:with-param name="str" select="//request/orderIdentifier"/>
    </xsl:call-template>
...
<fo:table-cell>
 ...
 <xsl:value-of select="//request/customerInformation/taxId"/> &#160; 
...
<fo:table-cell>
 ...
 {{invoice.label.paycreditcard}} &#160;  {{invoice.label.paycreditcard.mastercard}} &#160; 
...
<fo:table-cell>
 ...
 <xsl:value-of select="//request/invoiceData/invoiceNetAmount"/> &#160;  <xsl:value-of select="//request/paymentData/paymentCurrencyCode"/> &#160; 
...
<fo:block text-align="end" color="{$color}">
 ...
 <xsl:value-of select="//request/invoiceData/invoiceVatAmount"/> &#160;  <xsl:value-of select="//request/paymentData/paymentCurrencyCode"/> &#160; 
...
<fo:leader leader-pattern="rule" leader-length="100%" rule-style="solid" rule-thickness="1pt" text-align="end" color="#D4D7D8"/>
...
<fo:table-cell>
 ...
 <xsl:value-of select="//request/invoiceData/invoiceVoucherData/invoiceVoucherGrossAmount"/> &#160;  <xsl:value-of select="//request/paymentData/paymentCurrencyCode"/> &#160; 
...
<fo:leader leader-pattern="rule" leader-length="100%" rule-style="solid" rule-thickness="1pt" text-align="end" color="#B4B8BA"/>
...
<fo:table-cell>
 ...
 <xsl:value-of select="//request/invoiceData/invoiceVoucherData/invoiceVoucherNetAmount"/> &#160;  <xsl:value-of select="//request/paymentData/paymentCurrencyCode"/> &#160; 
...
<fo:block text-align="end" color="#B4B8BA">
 ...
 <xsl:value-of select="//request/invoiceData/invoiceVoucherData/invoiceVoucherVatAmount"/> &#160;  <xsl:value-of select="//request/paymentData/paymentCurrencyCode"/> &#160; 
...
<fo:table-cell>
 ...
 <xsl:value-of select="//request/invoiceData/invoiceGrossAmount"/> &#160;  <xsl:value-of select="//request/paymentData/paymentCurrencyCode"/> &#160; 
...
<fo:table-cell>
	...
	<fo:table table-layout="fixed" width="100%" border-collapse="separate" margin-top="-6.06mm" border-separation="4mm" xsl:use-attribute-sets="borderbottom">
