...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="SKODANext, sans-serif, SimSun">
        <fo:layout-master-set>
            <fo:simple-page-master master-name="first-page" page-height="29.7cm" page-width="21cm" margin-top="0.6cm"
                                   margin-bottom="2cm" margin-left="1.2cm" margin-right="1cm">
            ...
            <fo:simple-page-master master-name="all-pages" page-height="29.7cm" page-width="21cm" margin-top="0.6cm"
                                   margin-bottom="2cm" margin-left="1.2cm" margin-right="1cm">
